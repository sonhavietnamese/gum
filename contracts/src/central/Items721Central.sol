...
import {Items721} from "../items/Items721.sol";

contract Items721Central is Initializable {
    ...
    function initialize(address owner) external initializer {
        Items721 itemsImpl = new Items721();
    ...
    function createCollection(
        ...
        bytes memory initData = abi.encodeWithSelector(
            Items721(_implementation).initialize.selector,
            defaultAdmin,
            pauser,
            minter
        );
